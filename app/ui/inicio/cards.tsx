  ...
  return (
    ...
    <div className="relative flex flex-col my-6 bg-white shadow-sm border border-slate-200 rounded-lg w-96">
      <div className="relative h-56 m-2.5 overflow-hidden text-white rounded-md">
        <Image 
        // para colocar la imagen y que funcione no se debe de colocar la carpeta public, solo la ruta de la imagen.
        src="/cabana/cabana.png" 
        width={300}
        height={200}
        alt="card-image"
        />
      ...
      <div className="p-4">
        ...
        <p className="text-slate-600 leading-normal font-light">
          Hermosa cabaña cerca al mar y de fondo las hermosas montañas un excelente lugar para descanzar y divertirse en familia.
        </p>
      </div>
